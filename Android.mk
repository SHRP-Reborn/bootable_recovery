...
ifneq ($(SHRP_DEV_FLASH_BOTH_SLOTS),false)
	LOCAL_CFLAGS += -DSHRP_DEV_FLASH_BOTH_SLOTS
endif
...
ifneq ($(SHRP_EXCLUDE_MAGISK_FLASH),)
	LOCAL_CFLAGS += -DSHRP_EXCLUDE_MAGISK_FLASH
endif
ifneq ($(SHRP_LITE),)
...
ifeq ($(SHRP_EXCLUDE_MAGISK_FLASH),true)
	LOCAL_CFLAGS += -DSHRP_EXCLUDE_MAGISK_FLASH
endif
#FirstAddon
